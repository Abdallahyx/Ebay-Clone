...
function CartProduct(props) {
  ...
  const proceedToCheckout = () => {
    ...
    const truck=<svg xmlns="http://www.w3.org/2000/svg" width="21" height="14" viewBox="0 0 21 14" fill="currentColor">
    ...
    const handleSubtract = (index) => {
        if (productQuantities[index] === 0) return;
        const updatedQuantities = [...productQuantities];
        updatedQuantities[index] -= 1;
        setProductQuantities(updatedQuantities);
    };
    ...
    // Function to render individual product elements
                ...
                <div className="productcontents" key={i}>
                    ...
                    <div className="productdetails">
                        ...
                        <div className="quantity">
                            ...
                            <p>{productQuantities[i]}</p>
                            <button onClick={() => handleSubtract(i)}>-</button>
                        </div>
                        <div className="total">
                        <p >${productPrice * productQuantities[i]}</p>
                        </div>
                    </div>
                </div>
            );
        ...
        <div className="cartPage">
            ...
            <div className="pagecontent">
                ...
                <div className="checkout">
                  ...
                  <p>Buy <s>$75.00 </s>more to enjoy Free Shipping</p>
                  <p>Do you want a gift wrap? Only <s>$5.00</s></p>
